...
mkdir -p covid19
[[ -f covid19-refseq.fasta ]] || wget 'https://raw.githubusercontent.com/cfarkas/SARS-CoV-2-freebayes/master/covid19-refseq.fasta' -O covid19/covid19-refseq.fasta
[[ -f covid19-refseq.txt ]] || tail -n '+2' covid19/covid19-refseq.fasta > covid19/covid19-refseq.txt
