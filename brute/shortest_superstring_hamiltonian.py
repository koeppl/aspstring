...
def shortestSuperstring(strings):
		m = len(strings)
...
superstring = shortestSuperstring(strings)

print(f'RESULT length={len(superstring)} superstring={superstring} seconds={time.time() - start_time}')
